...
Outwave.js is a web based waveform viewer built to handle very long recordings. 
...
The library was developed for use in a subtitle editor. A [demo](http://outwave.dorotovic.name/demo/) is available.
