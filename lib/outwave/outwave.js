...
define([
    ...
    Outwave.prototype = {
        ...
        /**
         * Zoom in
         * @param  {Number} factor Factor by which to divide current zoom-value
         */
        zoomIn: function(factor){
            if(factor === undefined) factor = 2;
            this.setZoom(Math.max(1,Math.ceil(this.zoom/factor)));
        },
        /**
         * Zoom out
         * @param  {Number} factor Factor by which to divide current zoom-value
        ...
        /**
         * Set soom-value
         * @param {Number} zoom Zoom-value, number of audio samples which are collapsed into one pixel
         */
         ...
         * @param  {Function} fn Event handler accepting zoom-value as argument
         */
