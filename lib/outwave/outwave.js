...
define(
    ...
    function(DataFile, Viewer, SegmentCollection, Segment, Style, utils, Controls, TimeSpan, SparseTimeSpan, ContinuousTimeSpan, Draggable, TimeSpanCollection, SparseTimeSpanCollection, ContinuousTimeSpanCollection){
        ...
        var defaultOptions = {
            ...
            hover: true,
            mono: false,
            autoScrollType: 'smooth', // smooth or jerky

            autoScrollLeftThreshold: 0.2, //[percentage of width] position to which the viewer scrolls the cursor to
            autoscrollRightThreshold: 0.8, //[percentage of width] positon at which scrolling starts
